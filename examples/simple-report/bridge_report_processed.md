...
\newpage
\includepdf[pages=-]{appendices/structural analysis.pdf}

\begin{figure}[h!]
\centering
\includegraphics[width=6.45833in,height=3.66667in]{examples/simple-report/media/image1.jpeg}
\caption{Stress distribution diagram from finite
element analysis}
\end{figure}
